...
class CORR_METHODS(Enum):
    ...
    NCC_CORR = "ncc" #zhuang
    SGM_CORR = "sgm"
    WAVELET_NCC = "wavelet_ncc" #zhuang
    DTCWT_NCC = "dtcwt_ncc"

    CORR_METHODS_LIST = [FREQUENCY_CORR, SPATIAL_CORR, MM_CORR, NCC_CORR, WAVELET_NCC, DTCWT_NCC] #zhuang
...
class CORRELATION:
    ...
    NCC_CORRELATOR  = CORR_METHODS.NCC_CORR.value #zhuang
    WAVELET_NCC_CORRELATOR = CORR_METHODS.WAVELET_NCC.value #zhuang
    DTCWT_NCC_CORRELATOR = CORR_METHODS.DTCWT_NCC.value
